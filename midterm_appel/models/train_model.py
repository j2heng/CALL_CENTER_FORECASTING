...
class Model(object):
    ...
    def fit(self): 
        ...
        # OR
        self.model = GridSearchCV(RF, param_grid=param_dist, cv = cv , verbose=1, n_jobs=-1)  
...
#             'WDG_3', 'WDG_4', 'HG_1', 'HG_2', 'HG_3', 'Nb_appels_meanlag', 'Nb_appels_stdlag', 'LAGGED_LY_DW_avg_APPEL']
...
class MidTermModel(Model):
    ...
    def __init__(self, dataframe, now):
        ...
        #            'DAY_LENGTH', 'MG_1', 'MG_2', 'MG_3', 'WDG_1', 'WDG_2', 'WDG_3', 'WDG_4', 'MEAN_LAGGED_APPEL','STD_LAGGED_APPEL', 'LAGGED_LY_DW_avg_APPEL']
        # input_c =  ['xMONTH', 'yMONTH', 'xDAY', 'yDAY', 'xWD','yWD', 'JF','AftJF','BefJF','HolidaysFR','DAY_LENGTH']
        # input_c =  ['MEAN_LAGGED_APPEL','STD_LAGGED_APPEL', 'LAGGED_LY_DW_avg_APPEL']
        input_c =  ['xMONTH', 'yMONTH', 'xDAY', 'yDAY', 'xWD','yWD', 'JF','AftJF','BefJF','HolidaysFR','DAY_LENGTH', 'MEAN_LAGGED_APPEL','STD_LAGGED_APPEL']
